...
def choose_object(image_color, image_depth, heatmap, prompt = 'the cup', topk = 3, viz=False):
    ...
    if viz:
        for i, index in enumerate(top_k_indices):
            ...
            plt.title(f'rank{topk - i}; prob {probs[index]:.3f} for \"{prompt}\"')
